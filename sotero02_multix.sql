...
--
-- Host: localhost:3306
-- Generation Time: Feb 08, 2020 at 10:09 AM
...
(1, 'SAÚDE E BEM-ESTAR', 'Liber utroque vim an, ne his brute vivendo, est fabulas consetetur appellantur an in dolore.', 'fa fa-globe'),
(2, 'AGRICULTURA SUSTENTÁVEL', 'Vix tale noluisse voluptua ad, ne brute altera democritum cum. Omnes ornatus qui et, te aeterno.', 'fa fa-file-text'),
(3, 'REDUÇÃO DAS DESIGUALDADES', 'Mei ut errem legimus periculis, eos liber epicurei necessitatibus eu, facilisi postulant vel no.', 'fa fa-clock-o'),
(4, 'ENERGIA LIMPA E ACESSÍVEL', 'Ex vix alienum sadipscing, quod melius philosophia id has. Ad qui quem reprimique, quo possit.', 'fa fa-shield'),
(5, 'EDUCAÇÃO DE QUALIDADE', 'Vis constituto complectitur an, modo falli eirmod ea has. Ex vis indoctum scriptorem appellantur.', 'fa fa-commenting'),
(6, 'CONSUMO E PRODUÇÃO RESPONSÁVEIS', 'Ancillae interpretaris ea has. Id amet impedit qui, eripuit mnesarchum percipitur in eam.', 'fa fa-bullhorn');
...
(4, 'PAGE', 'Página'),
(5, 'EVENT', 'Evento'),
(6, 'PHOTO_GALLERY', 'Galeria de Fotos'),
(7, 'TESTIMONIAL', 'Depoimentos'),
(8, 'FAQ', 'FAQ'),
(9, 'PRICING_TABLE', 'Tabela de Preço '),
(10, 'SERVICE', 'Serviços'),
(11, 'PORTFOLIO', 'Portifólio'),
(12, 'NEWS', 'Notícias'),
(13, 'CONTACT', 'Contato'),
(14, 'SEARCH_FOR', 'Procurar por...'),
(15, 'READ_MORE', 'Consultar mais Informações'),
(16, 'SUBMIT', 'Enviar'),
(17, 'FIRST_NAME', 'Primeiro Nome'),
(18, 'LAST_NAME', 'Último Nome'),
(19, 'PHONE_NUMBER', 'Número de Telefone'),
(20, 'EMAIL_ADDRESS', 'Endereço de E-mail'),
(21, 'ADDRESS', 'Endereço'),
(22, 'MESSAGE', 'Mensagem'),
(23, 'START_DATE', 'Iniciar Evento'),
(24, 'END_DATE', 'Data Final'),
(25, 'EVENT_START_DATE', 'Data de Início do Evento'),
(26, 'EVENT_END_DATE', 'Evento e Data'),
(27, 'EVENT_LOCATION_MAP', 'Localização do Evento no Mapa'),
(28, 'SHARE_THIS_EVENT', 'Compartilhar o Evento'),
(29, 'SHARE_THIS_NEWS', 'Compartilhar a Notícia'),
(30, 'COMMENT', 'Comentário'),
(31, 'NAME', 'Nome'),
(32, 'ALL', 'Todos'),
(33, 'PROJECT_OVERVIEW', 'Visão Geral do Projeto'),
(34, 'CATEGORY', 'Categoria'),
(35, 'CLIENT_NAME', 'Nome do Cliente'),
(36, 'CLIENT_COMPANY_NAME', 'Nome da Empresa Cliente'),
(37, 'PROJECT_START_DATE', 'Data de Início do Projeto'),
(38, 'PROJECT_END_DATE', 'Data Final do Projeto'),
(39, 'CLIENT_COMMENT', 'Comentário do Cliente'),
(40, 'NEWS_DATE', 'Nova Data'),
(41, 'RECENT_PORTFOLIO', 'Portfólio Recente'),
(42, 'RECENT_PORTFOLIO_SUBTITLE', 'Veja todos os nossos trabalhos que fizemos para nossos clientes...'),
(43, 'CONTACT_FORM', 'Formulário de Contato'),
(44, 'SEND_MESSAGE', 'Enviar Mensagem'),
(45, 'SUBJECT', 'Destinatário'),
(46, 'NO_RESULT_FOUND', 'Nenhum Resultado Encontrado');
...
(1, 'Sobre Nós', '<h3><br></h3><div><div>O BrHorta gerará impacto positivo em várias frentes, já que este é um projeto integrador que atuará não só na utilização de forma inteligente dos espaços ociosos ao longo da linha do BRT, como também integrará tudo o que for produzido nos lotes de hortas, beneficiando comunidades circunvizinhas e impactadas pelo empreendimento, disponibilizando produtos a preços baixos, além da grande possibilidade de funcionar como ambiente de escambo popular.</div><div><br></div><div>O BrHorta integra 15 dos 17 (ODS´S) Objetivos para o Desenvolvimento Sustentável.</div></div><div><br></div>', 'Sobre Nós — BrHorta', '', '');
...
(1, 'BrHorta — Inteligência em Utilização de Espaços', '', '', 'UM VERDADEIRO LÍDER PODE', 'AJUDÁ-LO NOS NEGÓCIOS', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne.<br></p>', '<iframe src=\"https://player.vimeo.com/video/43982091\" style=\"position:absolute;width:100%;height:100%;left:0\" width=\"480\" height=\"360\" allowfullscreen></iframe>', 'Business Management', '95', 'Financial Management', '70', 'Project Management', '88', '', '', '', '', 'Show', 'home_welcome_video_bg.jpg', 'Porque nos escolher?', 'Temos alguns critérios especiais que ajudarão você', 'Show', 'CARACTERÍSTICAS ESPECIAIS', 'Oferecemos alguns recursos impressionantes que ajudarão você', 'Show', 'Nossos Serviços', 'Subtitulo aqui', 'Hide', 'Projetos', '150', 'fa fa-user', 'Visualizações', '300', 'fa fa-bar-chart', 'Clientes', '250', 'fa fa-users', 'Prêmios', '120', 'fa fa-trophy', 'counter.jpg', 'Hide', 'ACESSÓRIOS DE ITENS DE INVENTÁRIO', 'Veja abaixo a lista de itens do servidor', 'Hide', 'SOLICITE SEU ESPAÇO', 'PERGUNTAS FREQUENTES', 'Show', 'home_booking_photo.jpg', 'Nosso Time', 'Profissionais empenhados em fazer mais com menos', 'Show', 'Tabela de Preços do Cartão BrHorta', 'Nossos preços detalhados de serviços de consultoria estão listados abaixo', 'Show', 'Nossos Clientes', 'Veja o que nossos valiosos clientes dizem sobre nós', 'home_testimonial_photo.jpg', 'Hide', 'ÚLTIMAS NOTÍCIAS', 'Todas as nossas últimas notícias estão listadas abaixo', '10', 'Hide', 'Do you want to get our quality service for your business?', 'Contact Us', '#');
...
(1, 'Portifólio', 'Portífólio — BrHorta', '', '');
...
(1, 'Procurar por:', 'Procurar — BrHorta', '', '');
...
(1, 'Nossos Serviços ', 'Nossos Serviços — BrHorta', '', '');
...
(1, 'Membros da Equipe', 'Membros da Equipe — Sotero Systems', '', '');
...
(1, 'Termos e Condições', '<p>Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis. Duo volutpat imperdiet ut, postea salutatus imperdiet ut per, ad utinam debitis invenire has.</p><p>Liber utroque vim an, ne his brute vivendo, est fabulas consetetur appellantur an. In dolore legendos quo, ne ferri noluisse sed. Tantas eligendi at ius. Purto ipsum nemore sit ad.</p><p>Vix tale noluisse voluptua ad, ne brute altera democritum cum. Omnes ornatus qui et, te aeterno discere ocurreret sea. Tollit cetero cu usu, etiam evertitur id nec. Id pro unum pertinax oportere, vel ad ridens mollis. Ad ius meis suavitate voluptaria.</p><p>Mei ut errem legimus periculis, eos liber epicurei necessitatibus eu, facilisi postulant vel no. Ad mea commune disputando, cu vel choro exerci. Pri et oratio iisque atomorum, enim detracto mei ne, id eos soleat iudicabit. Ne reque reformidans mei, rebum delicata consequuntur an sit. Sea ad audire utamur. Ut mei ridens minimum intellegat, perpetua euripidis te qui, ad consul intellegebat comprehensam eum.</p><p>Ex vix alienum sadipscing, quod melius philosophia id has. Ad qui quem reprimique, quo possit detracto reprimique no, sint reque officiis ei per. Ea regione commune volutpat pro, fabulas facilis omnesque mei ne. Cu unum detracto comprehensam sea, ad vim ancillae principes, ex usu fugit consulatu. Vis te purto equidem voluptatum.</p><p>Detracto contentiones te est, brute ipsum consul an vis. Mea ei regione blandit ullamcorper, definiebas constituam vix ei. At his ludus nonumes gloriatur. Ne vim tamquam nonumes.</p><p>Duo purto pertinax in. Ea noluisse mediocrem qui, nobis melius vis et. Iudico delicatissimi no qui, quando fastidii nam et, ne eum rationibus deseruisse neglegentur. Ei eum populo viderer reprimique, tantas homero abhorreant usu ei, at postulant gloriatur vituperata sit.</p>', 'Termos e Condições — BrHorta', '', '');
...
(1, 'Depoimentos', 'Depoimentos — BrHorta', '', '');
...
(1, 'fa fa-shield', 'Bimestral', 'R$ 5,00', 'por mês', '<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li><li>Item 4</li><li>Item 5</li></ul>', 'Leia Mais!', '#'),
(2, 'fa fa-globe', 'Quadrimestral', 'R$ 5,00', 'por mês', '<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li><li>Item 4</li><li>Item 5</li></ul>', 'Leia Mais!', '#'),
(3, 'fa fa-diamond', 'Semestral', 'R$ 5,00', 'por mês', '<ul><li>Item 1</li><li>Item 2</li><li>Item 3</li><li>Item 4</li><li>Item 5</li></ul>', 'Leia Mais!', '#');
...
(1, 'logo.png', 'favicon.png', 'Inscreva-se                        ', 'Últimas Notícias             ', 'Nossos Projetos              ', 'Endereço                            ', 'Copyright © 2019, SoteroSytems. Todos os Direitos Reservados', '3153 Foley Street\r\nMiami, FL 33176', 'email@empresa.com\r\n', 'Compras: 71 9 8685-4005\r\nSuporte: 71 9 8685-4005', '3', '9', 'Detracto contentiones te est, brute ipsum consul an vis. Mea ei regione blandit ullamcorper, definiebas constituam vix ei.', 'Clique no Botão ao Lado para Entrar em Contato Conosco!', 'Contate-Nos', '#', 'cta_background.jpg', 'contato@brhorta.com.br', '71 9 1234-5678', 'contato@brhorta.com.br', 'contato@brhorta.com.br', 'banner_about.jpg', 'banner_faq.jpg', 'banner_service.jpg', 'banner_testimonial.jpg', 'banner_news.jpg', 'banner_event.jpg', 'banner_contact.jpg', 'banner_search.jpg', 'banner_terms.jpg', 'banner_privacy.jpg', 'banner_team.jpg', 'banner_portfolio.jpg', 'banner_verify_subscriber.jpg', 'banner_pricing.jpg', 'banner_photo_gallery.jpg', 'AAD98A', '3', '5', '5', 'Categorias', 'Posts Recentes', 'Próximos Eventos', 'Eventos Antigos', 'Nossos Serviços', 'Contato', 'Detalhes do Projeto', 'Contato');
...
(1, 'slider-1.png', '', '', '', '', '', '', 'Left'),
(2, 'slider-2.jpg', 'O BrHorta gerará impacto positivo em várias frentes', 'É um projeto integrador que atuará não só na utilização de forma inteligente dos espaços ociosos ao longo da linha do BRT.', 'Leia Mais', '#', 'Contate-nos', '#', 'Right');
...
(1, 'admin@admin.com', '2020-02-07', '2020-02-07 19:21:19', '9dcbec969f82408052af7612489aef16', 0);
